...
# PMOD PORT A ###################################################
# MC1-64 
set_property PACKAGE_PIN Y13 [get_ports {LENS_SPI_CLK}]
set_property IOSTANDARD LVCMOS33 [get_ports {LENS_SPI_CLK}]
# MC1-68 
...
# MC1-74 
set_property PACKAGE_PIN W16 [get_ports {LENS_SPI_MOSI}]
set_property IOSTANDARD LVCMOS33 [get_ports {LENS_SPI_MOSI}]
# MC2-67 
set_property PACKAGE_PIN T16 [get_ports {LENS_SPI_MISO}]
set_property IOSTANDARD LVCMOS33 [get_ports {LENS_SPI_MISO}]
# MC2-71 
...
# MC2-73 
set_property PACKAGE_PIN V14 [get_ports {a}]
